...
def myplot(row_names,column_names,file_name,ylabel,save_name,scale=1,yMax=0,log=False):
    ...
    df = pd.read_csv(file_name,names=['uf[K/10ms]','Naive',"COU","Fork","Zigzag","PingPong","FHC","FHCC"],header=None)
...
column_names = ['uf[K/10ms]','Naive',"COU","Fork","Zigzag","PingPong","FHC","FHCC"]
# column_names = ['uf[K/10ms]','Naive',"COU","Fork","Zigzag","PingPong"]
...
column_names = ['uf[K/10ms]',"Fork","PingPong","FHC","FHCC"]
# column_names = ['uf[K/10ms]','Naive',"COU","Fork","Zigzag","PingPong"]
row_names = ['16','32','64','128','256']
