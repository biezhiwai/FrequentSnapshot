...
def myplot(row_names,column_names,file_name,ylabel,save_name,scale=1,yMax=0):
    ...
    df = pd.read_csv(file_name,names=['alpha','Naive',"COU","Fork","Zigzag","PingPong","Fork-hot/cold","Fork-hot/cold+cou"],header=None)
...
column_names = ['alpha','Naive',"COU","Fork","Zigzag","PingPong","Fork-hot/cold","Fork-hot/cold+cou"]
...
column_names = ['alpha',"Fork","PingPong","Fork-hot/cold","Fork-hot/cold+cou"]
row_names = ['1.1','1.3','1.5','1.7','1.9']
