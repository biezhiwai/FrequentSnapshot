...
def myplot(row_names,column_names,file_name,ylabel,save_name,scale=1,yMax=0):
    ...
    df = pd.read_csv(file_name,names=['Row Size[B]','Naive',"COU","Fork","Zigzag","PingPong","Fork-hot/cold","Fork-hot/cold+cou"],header=None)
...
column_names = ['Row Size[B]','Naive',"COU","Fork","Zigzag","PingPong","Fork-hot/cold","Fork-hot/cold+cou"]
...
column_names = ['Row Size[B]',"Fork","PingPong","Fork-hot/cold","Fork-hot/cold+cou"]
row_names = ['64','128','256','512','1024']
